...
void applicationLoop() {
	...
	while (psi) {
		...
		//modelMatrixCyborg = glm::scale(modelMatrixCyborg, glm::vec3(0.1f));
		...
		modelMatrixGuardianBody = glm::rotate(modelMatrixGuardianBody, glm::radians(-90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
