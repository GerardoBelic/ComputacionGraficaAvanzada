...
std::vector<glm::vec3> lamp1Position = { glm::vec3(-7.03, 0, -19.14), glm::vec3(
		24.41, 0, -34.57), glm::vec3(-10.15, 0, -54.10), glm::vec3(17.96, 0, -51.08) };
std::vector<float> lamp1Orientation = { -17.0, -82.67, 23.70, -40.0 };
std::vector<glm::vec3> lamp2Position = { glm::vec3(-36.52, 0, -23.24),
		glm::vec3(-52.73, 0, -3.90), glm::vec3(62.69, 0, -14.64), glm::vec3(66.40, 0, -3.51), glm::vec3(69.72, 0, 5.46) };
std::vector<float> lamp2Orientation = {21.37 + 90, -65.0 + 90};

std::vector<glm::vec3> newLampPosition = {glm::vec3(70.12, 0, 8.82) };
std::vector<float> newLampOrientation = { 21.37 + 90, -65.0 + 90 };
...
void applicationLoop() {
	...
	while (psi) {
		...
		shaderMulLighting.setFloat("spotLightss[0].linear", 0.009);
		...
		for (int i = 0; i < newLampPosition.size(); i++) {
			...
			matrixAdjustLamp = glm::rotate(matrixAdjustLamp, glm::radians(newLampOrientation[i]), glm::vec3(0, 1, 0));
			matrixAdjustLamp = glm::scale(matrixAdjustLamp, glm::vec3(0.5, 0.5, 0.5));
			matrixAdjustLamp = glm::translate(matrixAdjustLamp, glm::vec3(0, 10.3585, 0));
